...
# # # ---------------------------For Followup page-----------
    ...
    # department = Select(driver.find_element_by_xpath("//select[@name='department_id']"))
    # #select by select_by_visible_text() method
    # department.select_by_visible_text("Sales")
    # time.sleep(5)

    # # select=Select(driver.find_element_by_css_selector('#followup-discussion-section > span > div.card-body.p-0 > div:nth-child(4) > div > div > span > select'))
    # # Select.select_by_visible_text('31')
    # # time.sleep(3)

    # enquiryStatus = Select(driver.find_element_by_xpath("//select[@name='status_id']"))
    # #select by select_by_visible_text() method
    # enquiryStatus.select_by_visible_text("Closed & Confirmed")
    # time.sleep(0.8)

    # driver.find_element_by_xpath('//*[@id="followup-discussion-section"]/span/div[2]/div[6]/div[2]/button').click()
    # time.sleep(1)

# ------------For Confirmation stage--------------

WebDriverWait(driver, 40).until(EC.element_to_be_clickable((By.CSS_SELECTOR, '#horizontalTab > ul > li:nth-child(3) > a'))).click()
driver.implicitly_wait(20)
time.sleep(3)
...
# confirmSelect = driver.find_element_by_css_selector('#Enquiry > div.card.card-timeline.card-plain > div > ul > li:nth-child(1) > div.timeline-panel.active-class > div.timeline-heading')
confirmSelect.click()
time.sleep(1)
...
receiveBy.send_keys('Subrata Bhakta')
receiveBy.click()
selected_receive = driver.find_element_by_xpath('/html/body/div[9]/div[1]/div[1]/ul/li[9]').click()
time.sleep(0.30)
driver.implicitly_wait(20)
...
paymentDateInput = driver.find_element_by_xpath('//*[@id="enquiry-form-validation"]/div[7]/div/span/form/fieldset/div/div[2]/div/div[1]/div/span/div/div/div/input')
paymentDateInput.send_keys(payment_Date)
time.sleep(0.30)
# driver.implicitly_wait(20)
...
driver.find_element_by_xpath('//*[@id="enquiry-form-validation"]/div[8]/div/div/div/button').click()
time.sleep(1)
print(driver.title)
# driver.close()
